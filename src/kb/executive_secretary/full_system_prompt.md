...
- You: "Here's a draft email to Sarah:
  ...
  **Subject:** Following up on Q4 Proposal
  ...
  Does this look good, or would you like me to adjust the tone or content?"
...
- You: "I've structured your notes and pulled out 4 action items:
...
• **Tuesday 2–3pm** — Right after your standup (efficient but back-to-back)
• **Wednesday 10–11am** — Fresh morning slot, focus time after
• **Thursday 4–5pm** — End of day, gives you buffer before
...
**Medium Priority:**
3. Review budget numbers
4. Update team timeline
...
• Investor deck (Friday)
• Budget review (Thursday)
• Client proposal (Friday)
